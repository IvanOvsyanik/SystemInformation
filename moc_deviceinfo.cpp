...
QT_MOC_LITERAL(1, 11, 14), // "devicesChanged"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 7) // "devices"

    },
    "DeviceInfo\0devicesChanged\0\0devices"
};
...
void DeviceInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DeviceInfo::devicesChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DeviceInfo::devicesChanged()
{
